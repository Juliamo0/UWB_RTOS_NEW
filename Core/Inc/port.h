...
extern port_deca_isr_t port_deca_isr;  // Changed from definition to declaration
...
/* DW1000 Pin Definitions - Adjusted for actual hardware */
// Using PA15 for RESET as per main.c
#define DW1000_RSTn                 GPIO_PIN_15
#define DW1000_RSTn_GPIO            GPIOA

// IRQ pin - define if connected, otherwise comment out
// #define DECAIRQ                     GPIO_PIN_X
// #define DECAIRQ_GPIO                GPIOX
...
/* NSS pin is NOT available on DWM1000 module - these macros are stubs */
#define port_SPIx_set_chip_select()     do {} while(0)
#define port_SPIx_clear_chip_select()   do {} while(0)

/* LCD NSS pin - not used */
#define port_SPIy_set_chip_select()     do {} while(0)
#define port_SPIy_clear_chip_select()   do {} while(0)
